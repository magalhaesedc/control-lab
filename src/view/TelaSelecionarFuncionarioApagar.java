 ...
 * @author edson
 */
public class TelaSelecionarFuncionarioApagar extends javax.swing.JFrame {

    /**
     * Creates new form TelaAlterarReserva
     */
    public TelaSelecionarFuncionarioApagar() {
        initComponents();
        iconeTitulo();
        perguntarSair();
        corFundo();
    ...
    private void bt_okSelecionarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_okSelecionarFuncionarioActionPerformed
        int selectedOption = JOptionPane.showConfirmDialog(null, "Deseja realmente apagar esse Funcionario?", "Control Lab Avisa", YES_NO_OPTION, QUESTION_MESSAGE);
        if (selectedOption == JOptionPane.YES_OPTION) {
            String nome = cp_listarFuncionarios.getSelectedItem().toString();
            Funcionario f = new Funcionario();
            f = bancoFuncionario.recuperarFuncionario(nome);
            JOptionPane.showMessageDialog(null, bancoFuncionario.apagar(f));
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecionarFuncionarioApagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
